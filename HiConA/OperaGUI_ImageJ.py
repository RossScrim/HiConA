...
class OperaGUI:
    ...
    def get_metadata(self, config_path: str):
        ...
        kw_file = config_path
        # print(kw_file)
        opera_config = ConfigReader(kw_file)
        return opera_config.load(remove_first_lines=1, remove_last_lines=2)
    ...
    def proc_confirm(self, imagej_proc_order=None):
        ...
        # No 3D options added yet - add here when needed
            ...
            for cur_measurement in self.measure_to_process:
                ...
                HiConAWorkflowHandler(cur_files,
                                ...
                                stitch_ref_ch=stitch_ref_ch,
                                imagej_loc=imagej_loc,
                                imagej_proc_order=imagej_proc_order).run()
...
class HiConAWorkflowHandler:
    ...
    def _preprocessor(self, images):
            ...
            processor = ImageProcessor(image, self.config_file)
